...
class MovesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create move" do
    assert_difference('Move.count') do
      post moves_url, params: { move: { accuracy: @move.accuracy, name: @move.name, power: @move.power, pp: @move.pp } }
    end
  ...
  test "should update move" do
    patch move_url(@move), params: { move: { accuracy: @move.accuracy, name: @move.name, power: @move.power, pp: @move.pp } }
